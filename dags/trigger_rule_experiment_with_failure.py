...
BIGQUERY_TABLES = {
    ...
    "data/trigger_test_sample_data2.csv": "trigger_test_data3",
}
...
# DAG definition
with DAG(
    "trigger_rule_experiment_with_failure_dag",
            ...
            configuration={
                "query": {
                    "query": f"""
                        ...
                        UNION ALL
                        SELECT * FROM `{PROJECT_ID}.{BIGQUERY_DATASET}.trigger_test_data3`
                    """,
                    "useLegacySql": False,
                    "destinationTable": {
                        "projectId": PROJECT_ID,
